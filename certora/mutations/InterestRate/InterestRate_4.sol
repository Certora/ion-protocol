...
contract InterestRate {
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 adjustedBelowKinkSlope;
        {
            ...
            unchecked {
                // mutation: switch collateralApyRayInSeconds with ilkData.adjustedProfitMargin
                slopeNumerator = ilkData.adjustedProfitMargin - collateralApyRayInSeconds - ilkData.adjustedBaseRate;
            }
