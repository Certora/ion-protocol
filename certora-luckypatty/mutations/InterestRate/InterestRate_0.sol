...
contract InterestRate {
        ...
        returns (uint256, uint256)
    {
        ...
        // Above kink
            ...
            // mutation: repalce rayMulDown with rayDivUp
            uint256 adjustedNormalRate =
                adjustedBelowKinkSlope.rayDivUp(optimalUtilizationRateRay) + ilkData.adjustedBaseRate;
            uint256 minimumNormalRate =
                minimumBelowKinkSlope.rayDivUp(optimalUtilizationRateRay) + ilkData.minimumBaseRate;
